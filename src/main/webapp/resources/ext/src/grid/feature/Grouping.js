...
Ext.define('Ext.grid.feature.Grouping', {
    ...
    //<locale>
    expandTip: 'Клик что бы развернуть. CTRL схлопывает все остальные',
    //</locale>

    //<locale>
    collapseTip: 'Клик что бы схлопнуть. CTRL/клик схлопывает все остальные',
    //</locale>
